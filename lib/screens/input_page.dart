...
import 'package:bmi_calculator/widgets/icons-content.dart';
...
class _NoteInputState extends State<NoteInput> {
  Color maleCardColor, femaleCardColor = kInactiveCardColor;
  int height = 180;
  int weight = 60;
  int age = 20;
                ...
                children: [
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      inactiveTrackColor:
                          kInactiveSliderColor.withOpacity(0.50),
                      ...
                      overlayColor: kBottomContainerColor.withOpacity(0.25),
                    ),
                    child: Slider(
